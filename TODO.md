...
- Upstream PR [#24](https://github.com/Pickle-Pixel/ApplyPilot/pull/24) has been merged after isolated-branch validation.
  Known tradeoff:
  - LiteLLM path makes `doctor` fetch remote model metadata on startup.
